...
philly_crimes_sf <- st_read("data/PhillyCrimerate") # DONT NOT NEED THIS IF CREATION BELOW IS FIXED
...
philly_intersection
plot(st_geometry(philly_sf), border="#aaaaaa", main="Census tracts around city center, clipped by 2km buffer ")
