...
#HARV <- raster("data/HARV_RGB_Ortho.tif")
crs(HARV)
HARV.WGS84 <- projectRaster(HARV, crs="+init=epsg:4326")
...
prj <- CRS("+init=epsg:4326") # the projection string for WGS84
...
### some additional packages that use vector data
...
There are packages thast specialize on the [GeoJSON](https://tools.ietf.org/html/rfc7946) format specifically and for that reason are more lightweight, for example:

- [`geojson`](https://cran.r-project.org/package=geojson) and
- [`geoops`](https://CRAN.R-project.org/package=geoops)

https://cran.r-project.org/web/packages/geoops/vignettes/geoops_vignette.html
https://cran.r-project.org/web/packages/geojson/index.html
