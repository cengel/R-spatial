...
download.file("https://www.dropbox.com/s/g5p8b1xi2k5lydw/RSpatialDataTypes.zip?dl=1", "data/RSpatialDataTypes.zip")
unzip("data/RSpatialDataTypes.zip", exdir = "data")
```

You can also download the data manually here [RSpatialDataTypes.zip]("https://www.dropbox.com/s/g5p8b1xi2k5lydw/RSpatialDataTypes.zip?dl=1", "data/RSpatialDataTypes.zip") and extract them
...
## Acknowledgements {-}
Some of the materials for this tutorial are adapted from http://datacarpentry.org and https://github.com/MicheleTobias/R-Projections-Workshop 
